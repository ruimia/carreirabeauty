...
function FooterCol({ title, links }: { title: string; links: { label: string; href: string }[] }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
      ...
      {links.map((l) => (
        // Rodapé aparece em toda página pública — prefetch ligado nesses
        // links geraria uma leva de requisições em segundo plano a cada
        // carregamento, pra páginas que quase ninguém clica na sequência.
